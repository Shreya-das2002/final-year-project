...
export const SIDE_NAV_CONTROLS: string[] = [
  ...
  "add doctor",
  "pending doctor list",
  "standard pending doctor list",
  "guest pending doctor list",
  "admin list",
  "doctor list",
  "messages",
...
export const MENU_ROUTE_MAP: Record<string, string> = {
  ...
  "standard pending doctor list": "/admin/standard_pending_doctor_list",
  "guest pending doctor list": "/admin/guest_pending_doctor_list",
