...
const SpDoctorList = () => {
  ...
  // ✅ OPEN CALENDAR (SAME AS SLOT FILE)
      ...
      {loading ? (
        ...
        <div className="p-4 space-y-4">
          ...
          {doctors.map((doc: Doctor) => (
            <div
              key={doc.doctor_id}
              className="bg-gradient-to-r from-cyan-100/40 to-teal-200/30 rounded-xl flex justify-between items-center p-5 shadow hover:scale-105 transition"
            >
              {/* LEFT */}
              ...
              <div className="grid grid-cols-7 gap-2">
                ...
                {[...Array(daysInMonth)].map((_, i) => {
                  ...
                  return (
                    <div
                      key={day}
                      className="h-14 flex items-center justify-center border rounded-lg cursor-pointer hover:bg-cyan-100"
                      onClick={() => {
