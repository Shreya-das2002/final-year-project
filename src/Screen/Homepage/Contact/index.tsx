  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 px-4 py-10">
      ...
      <div className="max-w-4xl mx-auto text-center mb-10">
        <h1 className="text-4xl font-bold bg-linear-to-r from-blue-600 to-blue-300 bg-clip-text text-transparent dark:text-white mb-3">
          Contact Us
        </h1>
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-6 mb-10">
        <div className="bg-linear-to-r from-blue-50 to-blue-200 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl shadow text-center">
...
<div className="max-w-4xl mx-auto mb-12">
  <h2 className="text-3xl font-bold text-center bg-linear-to-r from-blue-600 to-blue-300 bg-clip-text text-transparent dark:text-white mb-6">
    Our Team
  </h2>
  ...
  <div className="grid md:grid-cols-4 gap-6">
    {teamMembers.map((member) => (
      <div
        key={member.name}
        className="bg-linear-to-r from-blue-100 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-6 rounded-xl shadow text-center"
      >
  ...
  <span className="truncate">{member.email}</span>
      ...
      {/* ================= CONTACT FORM ================= */}
      <div className="max-w-3xl mx-auto bg-linear-to-r from-blue-100 via-blue-50 to-blue-100 dark:from-gray-800 dark:via-gray-700 dark:to-gray-700 rounded-2xl shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 rounded-md border dark:text-gray-200 dark:border-gray-600 bg-transparent focus:ring-2 focus:ring-blue-500 outline-none"
          ...
          <button
            type="submit"
            className="w-full bg-linear-to-r from-blue-400 to-blue-600 dark:from-gray-600 dark:to-gray-600 text-white py-2 rounded-md font-semibold hover:from-blue-500 hover:to-blue-700 dark:hover:from-gray-500 dark:hover:to-gray-500 transition"
          >
            Send Message
          </button>
        </form>
